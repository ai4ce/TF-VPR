...
def get_query_tuple_supervise(dict_value, num_pos, num_neg, QUERY_DICT, hard_neg=[], other_neg=False):
        # get query tuple for dictionary entry
        # return list [query,positives,negatives]
...
def get_query_tuple_RGB_real(dict_value, num_pos, num_neg, QUERY_DICT, hard_neg=[], other_neg=False):
        # get query tuple for dictionary entry
        # return list [query,positives,negatives]
    #print("query:"+str(dict_value["query"]))
    query = load_image_file(dict_value["query"], full_path=False)  # Nx3
