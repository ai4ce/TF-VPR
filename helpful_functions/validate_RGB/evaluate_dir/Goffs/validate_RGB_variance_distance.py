...
def validate(temp_index):
    ...
    #mode = "Our_method_RGB"
    mode = "Our_method_RGB_w_distance"
   ...
   # mode = "Method_2_RI_RGB_no_feat__w_temporal"
    ...
    elif mode == "Our_method_RGB_w_distance":
        new_dir = "/mnt/NAS/home/cc/Our_method_RGB/Our_method_RGB_w_distance_check/results/"
    ...
    nbrs_21 = NearestNeighbors(n_neighbors=51, algorithm='ball_tree').fit(best_matrix_sec)
