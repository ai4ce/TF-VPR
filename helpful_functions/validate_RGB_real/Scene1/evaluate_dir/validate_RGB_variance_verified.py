...
def validate(temp_index):
    ...
    #mode = "Our_method_RGB"
    mode = "Our_method_RGB_w_verification"
   ...
   # mode = "Method_2_RI_RGB_no_feat__w_temporal"
    ...
    elif mode == "Our_method_RGB_w_verification":
        new_dir = "/mnt/NAS/home/cc/Our_method_RGB_real/Our_method_RGB_w_verification/results/"
