...
def validate(temp_index):
    ...
    #mode = "Our_method_RGB"
    mode = "Our_method_RGB_w_temporal5"
   ...
   # mode = "Method_2_RI_RGB_no_feat__w_temporal"
    ...
    elif mode == "Our_method_RGB_w_temporal5":
        new_dir = "/mnt/NAS/home/cc/Our_method_RGB_real/Our_method_RGB_w_temporal5/results/"
    ...
    for i in range(len(indices_21)):
        i_neighbors = list(range((-k_nearest//2)+i, (k_nearest//2)+i+1))
        indices_21_per = list(indices_21[i].copy())
        for j in i_neighbors:
            try:
                indices_21_per.remove(j)
            except:
                pass

        #print("indices_21_per_after:"+str(indices_21_per))
        #indices_21_backup.append(indices_21_per)
        indices_10.append(indices_21_per[:10])
        indices_5.append(indices_21_per[:5])
        indices_1.append(indices_21_per[:1])
