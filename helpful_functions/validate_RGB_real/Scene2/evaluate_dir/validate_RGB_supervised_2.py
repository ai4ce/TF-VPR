...
def validate(temp_index):
    ...
    #mode = "Our_method_RGB"
    mode = "Our_method_RGB_w_supervise"
   ...
   # mode = "Method_2_RI_RGB_no_feat__w_temporal"
    ...
    elif mode == "Our_method_RGB_w_supervise":
    ...
    data_dir = '/mnt/NAS/home/cc/data/habitat_3/train/Goffs/'
    ...
    indice_ = tree.query_radius(location_ests, r=0.2)
