...
def generate(data_index):
    ...
    for folder in folders:
        ...
        for (indx, file_) in enumerate(all_files): 
            ...
            df_files_all.append(os.path.join(cc_dir,runs_folder,folder,file_))
            df_indices_all.append(indx)
    ...
    construct_dict(df_files_all, df_indices_all, "train_pickle/all_queries_baseline_"+str(data_index)+".pickle", folder_size, folder_num, all_folders, pre_dir, k_nearest, k_furthest)
