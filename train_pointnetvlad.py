...
cfg.ALL_FILE = 'generating_queries/train_pickle/all_queries_baseline_0.pickle'
...
ALL_QUERIES = get_queries_dict(cfg.ALL_FILE)
...
def train():
    ...
    global TRAINING_QUERIES, TEST_QUERIES, ALL_QUERIES
    ...
    for epoch in range(starting_epoch, cfg.MAX_EPOCH):
        ...
        ALL_FILE = 'generating_queries/train_pickle/all_queries_baseline_'+str(epoch)+'.pickle'

        # Load dictionary of training queries
        TRAINING_QUERIES = get_queries_dict(TRAIN_FILE)
        TEST_QUERIES = get_queries_dict(TEST_FILE)
        ALL_QUERIES = get_queries_dict(ALL_FILE)
            ...
            if (len(TRAINING_LATENT_VECTORS) == 0):
                q_tuples.append(
                    get_query_tuple(TRAINING_QUERIES[batch_keys[j]], cfg.TRAIN_POSITIVES_PER_QUERY, cfg.TRAIN_NEGATIVES_PER_QUERY,
                                    ALL_QUERIES, hard_neg=[], other_neg=True))
